...
public class LamaWTFIfExpressionImplWTF extends ASTWrapperPsiElement implements LamaWTFIfExpression {

  public LamaWTFIfExpressionImplWTF(@NotNull ASTNode node) {
    super(node);
  }
