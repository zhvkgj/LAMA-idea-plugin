...
public class LamaWTFLazyExpressionImplWTF extends ASTWrapperPsiElement implements LamaWTFLazyExpression {

  public LamaWTFLazyExpressionImplWTF(ASTNode node) {
    super(node);
  }
